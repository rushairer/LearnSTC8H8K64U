...
// ADC_input(PIN)           set ADC input pin (see below for valid pins)
...
// ADC-pins: P00 - P06, P10, P11, P13 - P17, P54.
...
#define PIN_input(PIN) \
    ((PIN >= P00) && (PIN <= P07) ? (P0M1 |= (1 << (PIN & 7)), P0M0 &= ~(1 << (PIN & 7)), P0PU &= ~(1 << (PIN & 7))) : ((PIN >= P10) && (PIN <= P17) ? (P1M1 |= (1 << (PIN & 7)), P1M0 &= ~(1 << (PIN & 7)), P1PU &= ~(1 << (PIN & 7))) : ((PIN >= P20) && (PIN <= P27) ? (P2M1 |= (1 << (PIN & 7)), P2M0 &= ~(1 << (PIN & 7)), P2PU &= ~(1 << (PIN & 7))) : ((PIN >= P30) && (PIN <= P37) ? (P3M1 |= (1 << (PIN & 7)), P3M0 &= ~(1 << (PIN & 7)), P3PU &= ~(1 << (PIN & 7))) : ((PIN >= P40) && (PIN <= P47) ? (P4M1 |= (1 << (PIN & 7)), P4M0 &= ~(1 << (PIN & 7)), P4PU &= ~(1 << (PIN & 7))) : ((PIN >= P50) && (PIN <= P57) ? (P5M1 |= (1 << (PIN & 7)), P5M0 &= ~(1 << (PIN & 7)), P5PU &= ~(1 << (PIN & 7))) : ((PIN >= P60) && (PIN <= P67) ? (P6M1 |= (1 << (PIN & 7)), P6M0 &= ~(1 << (PIN & 7)), P6PU &= ~(1 << (PIN & 7))) : ((PIN >= P70) && (PIN <= P77) ? (P7M1 |= (1 << (PIN & 7)), P7M0 &= ~(1 << (PIN & 7)), P7PU &= ~(1 << (PIN & 7))) : (0)))))))))
...
#define PIN_pullup(PIN) \
    ((PIN >= P00) && (PIN <= P07) ? (P0PU |= (1 << (PIN & 7))) : ((PIN >= P10) && (PIN <= P17) ? (P1PU |= (1 << (PIN & 7))) : ((PIN >= P20) && (PIN <= P27) ? (P2PU |= (1 << (PIN & 7))) : ((PIN >= P30) && (PIN <= P37) ? (P3PU |= (1 << (PIN & 7))) : ((PIN >= P40) && (PIN <= P47) ? (P4PU |= (1 << (PIN & 7))) : ((PIN >= P50) && (PIN <= P57) ? (P5PU |= (1 << (PIN & 7))) : ((PIN >= P60) && (PIN <= P67) ? (P6PU |= (1 << (PIN & 7))) : ((PIN >= P70) && (PIN <= P77) ? (P7PU |= (1 << (PIN & 7))) : (0)))))))))
...
// ===================================================================================
#define PIN_fast(PIN) \
    ((PIN >= P00) && (PIN <= P07) ? (P0SR &= ~(1 << (PIN & 7))) : ((PIN >= P10) && (PIN <= P17) ? (P1SR &= ~(1 << (PIN & 7))) : ((PIN >= P20) && (PIN <= P27) ? (P2SR &= ~(1 << (PIN & 7))) : ((PIN >= P30) && (PIN <= P37) ? (P3SR &= ~(1 << (PIN & 7))) : ((PIN >= P40) && (PIN <= P47) ? (P4SR &= ~(1 << (PIN & 7))) : ((PIN >= P50) && (PIN <= P57) ? (P5SR &= ~(1 << (PIN & 7))) : ((PIN >= P60) && (PIN <= P67) ? (P6SR &= ~(1 << (PIN & 7))) : ((PIN >= P70) && (PIN <= P77) ? (P7SR &= ~(1 << (PIN & 7))) : (0)))))))))
...
#define PIN_enable(PIN) \
    ((PIN >= P00) && (PIN <= P07) ? (P0IE |= (1 << (PIN & 7))) : ((PIN >= P10) && (PIN <= P17) ? (P1IE |= (1 << (PIN & 7))) : ((PIN >= P20) && (PIN <= P27) ? (P2IE |= (1 << (PIN & 7))) : ((PIN >= P30) && (PIN <= P37) ? (P3IE |= (1 << (PIN & 7))) : ((PIN >= P40) && (PIN <= P47) ? (P4IE |= (1 << (PIN & 7))) : ((PIN >= P50) && (PIN <= P57) ? (P5IE |= (1 << (PIN & 7))) : ((PIN >= P60) && (PIN <= P67) ? (P6IE |= (1 << (PIN & 7))) : ((PIN >= P70) && (PIN <= P77) ? (P7IE |= (1 << (PIN & 7))) : (0)))))))))
...
#define PIN_strong(PIN) \
    ((PIN >= P00) && (PIN <= P07) ? (P0DR &= ~(1 << (PIN & 7))) : ((PIN >= P10) && (PIN <= P17) ? (P1DR &= ~(1 << (PIN & 7))) : ((PIN >= P20) && (PIN <= P27) ? (P2DR &= ~(1 << (PIN & 7))) : ((PIN >= P30) && (PIN <= P37) ? (P3DR &= ~(1 << (PIN & 7))) : ((PIN >= P40) && (PIN <= P47) ? (P4DR &= ~(1 << (PIN & 7))) : ((PIN >= P50) && (PIN <= P57) ? (P5DR &= ~(1 << (PIN & 7))) : ((PIN >= P60) && (PIN <= P67) ? (P6DR &= ~(1 << (PIN & 7))) : ((PIN >= P70) && (PIN <= P77) ? (P7DR &= ~(1 << (PIN & 7))) : (0)))))))))
...
#define PIN_ST_enable(PIN) \
    ((PIN >= P00) && (PIN <= P07) ? (P0NCS &= ~(1 << (PIN & 7))) : ((PIN >= P10) && (PIN <= P17) ? (P1NCS &= ~(1 << (PIN & 7))) : ((PIN >= P20) && (PIN <= P27) ? (P2NCS &= ~(1 << (PIN & 7))) : ((PIN >= P30) && (PIN <= P37) ? (P3NCS &= ~(1 << (PIN & 7))) : ((PIN >= P40) && (PIN <= P47) ? (P4NCS &= ~(1 << (PIN & 7))) : ((PIN >= P50) && (PIN <= P57) ? (P5NCS &= ~(1 << (PIN & 7))) : ((PIN >= P60) && (PIN <= P67) ? (P6NCS &= ~(1 << (PIN & 7))) : ((PIN >= P70) && (PIN <= P77) ? (P7NCS &= ~(1 << (PIN & 7))) : (0)))))))))
...
#define PWM_start(PIN) \
    ((PIN == P10) ? (PWMA_PS &= 0xfc, PWMA_ENO |= 0x01) : ((PIN == P11) ? (PWMA_PS &= 0xfc, PWMA_ENO |= 0x02) : ((PIN == P12) ? (PWMA_PS &= 0xf3, PWMA_ENO |= 0x04) : ((PIN == P13) ? (PWMA_PS &= 0xf3, PWMA_ENO |= 0x08) : ((PIN == P14) ? (PWMA_PS &= 0xcf, PWMA_ENO |= 0x10) : ((PIN == P15) ? (PWMA_PS &= 0xcf, PWMA_ENO |= 0x20) : ((PIN == P16) ? (PWMA_PS &= 0x3f, PWMA_ENO |= 0x40) : ((PIN == P17) ? (PWMA_PS &= 0x3f, PWMA_ENO |= 0x80) : ((PIN == P20) ? (PWMA_PS &= 0xfc, PWMA_PS |= 0x01, PWMA_ENO |= 0x01) : ((PIN == P21) ? (PWMA_PS &= 0xfc, PWMA_PS |= 0x01, PWMA_ENO |= 0x02) : ((PIN == P22) ? (PWMA_PS &= 0xf3, PWMA_PS |= 0x04, PWMA_ENO |= 0x04) : ((PIN == P23) ? (PWMA_PS &= 0xf3, PWMA_PS |= 0x04, PWMA_ENO |= 0x08) : ((PIN == P24) ? (PWMA_PS &= 0xcf, PWMA_PS |= 0x10, PWMA_ENO |= 0x10) : ((PIN == P25) ? (PWMA_PS &= 0xcf, PWMA_PS |= 0x10, PWMA_ENO |= 0x20) : ((PIN == P26) ? (PWMA_PS &= 0x3f, PWMA_PS |= 0x40, PWMA_ENO |= 0x40) : ((PIN == P27) ? (PWMA_PS &= 0x3f, PWMA_PS |= 0x40, PWMA_ENO |= 0x80) : ((PIN == P34) ? (PWMA_PS |= 0xc0, PWMA_ENO |= 0x40) : ((PIN == P33) ? (PWMA_PS |= 0xc0, PWMA_ENO |= 0x80) : (0)))))))))))))))))))

#define PWM_stop(PIN) \
    ((PIN == P10) ? (PWMA_ENO &= ~0x01) : ((PIN == P11) ? (PWMA_ENO &= ~0x02) : ((PIN == P12) ? (PWMA_ENO &= ~0x04) : ((PIN == P13) ? (PWMA_ENO &= ~0x08) : ((PIN == P14) ? (PWMA_ENO &= ~0x10) : ((PIN == P15) ? (PWMA_ENO &= ~0x20) : ((PIN == P16) ? (PWMA_ENO &= ~0x40) : ((PIN == P17) ? (PWMA_ENO &= ~0x80) : ((PIN == P20) ? (PWMA_ENO &= ~0x01) : ((PIN == P21) ? (PWMA_ENO &= ~0x02) : ((PIN == P22) ? (PWMA_ENO &= ~0x04) : ((PIN == P23) ? (PWMA_ENO &= ~0x08) : ((PIN == P24) ? (PWMA_ENO &= ~0x10) : ((PIN == P25) ? (PWMA_ENO &= ~0x20) : ((PIN == P26) ? (PWMA_ENO &= ~0x40) : ((PIN == P27) ? (PWMA_ENO &= ~0x80) : ((PIN == P34) ? (PWMA_ENO &= ~0x40) : ((PIN == P33) ? (PWMA_ENO &= ~0x80) : (0)))))))))))))))))))

#define PWM_write(PIN, val) \
    ((PIN == P10) ? (PWMA_CCR1L = (val)) : ((PIN == P11) ? (PWMA_CCR1L = ~(val)) : ((PIN == P12) ? (PWMA_CCR2L = (val)) : ((PIN == P13) ? (PWMA_CCR2L = ~(val)) : ((PIN == P14) ? (PWMA_CCR3L = (val)) : ((PIN == P15) ? (PWMA_CCR3L = ~(val)) : ((PIN == P16) ? (PWMA_CCR4L = (val)) : ((PIN == P17) ? (PWMA_CCR4L = ~(val)) : ((PIN == P20) ? (PWMA_CCR1L = (val)) : ((PIN == P21) ? (PWMA_CCR1L = ~(val)) : ((PIN == P22) ? (PWMA_CCR2L = (val)) : ((PIN == P23) ? (PWMA_CCR2L = ~(val)) : ((PIN == P24) ? (PWMA_CCR3L = (val)) : ((PIN == P25) ? (PWMA_CCR3L = ~(val)) : ((PIN == P26) ? (PWMA_CCR4L = (val)) : ((PIN == P27) ? (PWMA_CCR4L = ~(val)) : ((PIN == P34) ? (PWMA_CCR4L = (val)) : ((PIN == P33) ? (PWMA_CCR4L = ~(val)) : (0)))))))))))))))))))

// ===================================================================================
// ADC functions (P00 - P06, P10, P11, P13 - P17, P54, VREF only)
// ===================================================================================
...
#define ADC_input(PIN) \
    ((PIN == P10) ? (ADC_CONTR &= 0xf0) : ((PIN == P11) ? (ADC_CONTR &= 0xf0, ADC_CONTR |= 0x01) : ((PIN == P54) ? (ADC_CONTR &= 0xf0, ADC_CONTR |= 0x02) : ((PIN == P13) ? (ADC_CONTR &= 0xf0, ADC_CONTR |= 0x03) : ((PIN == P14) ? (ADC_CONTR &= 0xf0, ADC_CONTR |= 0x04) : ((PIN == P15) ? (ADC_CONTR &= 0xf0, ADC_CONTR |= 0x05) : ((PIN == P16) ? (ADC_CONTR &= 0xf0, ADC_CONTR |= 0x06) : ((PIN == P17) ? (ADC_CONTR &= 0xf0, ADC_CONTR |= 0x07) : ((PIN == P00) ? (ADC_CONTR &= 0xf0, ADC_CONTR |= 0x08) : ((PIN == P01) ? (ADC_CONTR &= 0xf0, ADC_CONTR |= 0x09) : ((PIN == P02) ? (ADC_CONTR &= 0xf0, ADC_CONTR |= 0x0a) : ((PIN == P03) ? (ADC_CONTR &= 0xf0, ADC_CONTR |= 0x0b) : ((PIN == P04) ? (ADC_CONTR &= 0xf0, ADC_CONTR |= 0x0c) : ((PIN == P05) ? (ADC_CONTR &= 0xf0, ADC_CONTR |= 0x0d) : ((PIN == P06) ? (ADC_CONTR &= 0xf0, ADC_CONTR |= 0x0e) : (0))))))))))))))))
...
inline uint16_t ADC_read_VDD(void)
{
    ...
    return ((uint32_t)1190 * 4095 / ADC_read()); // return VDD in mV
}
...
#define CMP_pos_pin(PIN) \
    ((PIN == P37) ? (CMPCR1 &= ~0x08) : ((PIN == P10) ? (CMPCR1 |= 0x08, ADC_CONTR &= 0xf0) : ((PIN == P11) ? (CMPCR1 |= 0x08, ADC_CONTR &= 0xf0, ADC_CONTR |= 0x01) : ((PIN == P54) ? (CMPCR1 |= 0x08, ADC_CONTR &= 0xf0, ADC_CONTR |= 0x02) : ((PIN == P13) ? (CMPCR1 |= 0x08, ADC_CONTR &= 0xf0, ADC_CONTR |= 0x03) : ((PIN == P14) ? (CMPCR1 |= 0x08, ADC_CONTR &= 0xf0, ADC_CONTR |= 0x04) : ((PIN == P15) ? (CMPCR1 |= 0x08, ADC_CONTR &= 0xf0, ADC_CONTR |= 0x05) : ((PIN == P16) ? (CMPCR1 |= 0x08, ADC_CONTR &= 0xf0, ADC_CONTR |= 0x06) : ((PIN == P17) ? (CMPCR1 |= 0x08, ADC_CONTR &= 0xf0, ADC_CONTR |= 0x07) : ((PIN == P00) ? (CMPCR1 |= 0x08, ADC_CONTR &= 0xf0, ADC_CONTR |= 0x08) : ((PIN == P01) ? (CMPCR1 |= 0x08, ADC_CONTR &= 0xf0, ADC_CONTR |= 0x09) : ((PIN == P02) ? (CMPCR1 |= 0x08, ADC_CONTR &= 0xf0, ADC_CONTR |= 0x0a) : ((PIN == P03) ? (CMPCR1 |= 0x08, ADC_CONTR &= 0xf0, ADC_CONTR |= 0x0b) : ((PIN == P04) ? (CMPCR1 |= 0x08, ADC_CONTR &= 0xf0, ADC_CONTR |= 0x0c) : ((PIN == P05) ? (CMPCR1 |= 0x08, ADC_CONTR &= 0xf0, ADC_CONTR |= 0x0d) : ((PIN == P06) ? (CMPCR1 |= 0x08, ADC_CONTR &= 0xf0, ADC_CONTR |= 0x0e) : (0)))))))))))))))))
